...
#pragma config(Motor, port6, topRightL, tmotorNormal, openLoop, reversed)
#pragma config(Motor, port7, bottomRightL, tmotorNormal, openLoop, reversed)
#pragma config(Motor, port8, topLeftL, tmotorNormal, openLoop)
#pragma config(Motor, port9, bottomLeftL, tmotorNormal, openLoop)
...
--------------------------------------------------------------------------------------------------*/
void setLiftMotors(int value) {
	motor[topRightL] = value;
	motor[bottomRightL] = value;
	motor[topLeftL] = value;
	motor[bottomLeftL] = value;
}
