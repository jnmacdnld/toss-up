...
#pragma config(Motor,  port6,           leftIntake,    tmotorVex393HighSpeed, openLoop)
...
task main() {
  fillMotorSpeedsArrWithUnadjusted(rightDrive);
  ...
  fillMotorSettingLut();
  fillMotorSpeedsArrWithAdjusted(rightDrive);
